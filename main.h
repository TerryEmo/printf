...
int handle_print(const char *fmt, int *i, va_list, char buffer[], int flags,
...
int handle_write(char c, char buffer[], int flags,
		int width, int precision, int size);
int write_number(int is_positive, int ind, char buffer[], int flags,
		int width, int ptrecision, int size);
int write_pointer(char buffer[], int ind, int length, int width,
		int flags, char padd, char extra_c, int padd_start);
int write_unsgd(int is_negative, int ind, char buffer[],
